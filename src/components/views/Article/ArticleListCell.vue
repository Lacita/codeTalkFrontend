<template>
  <div>
    <a>
        <iv-card  class="ivu">
          <div class="ivu-row" >
            <router-link target="_blank" :to="{name:'articleDetails',params:{articleId:article.id}}">
              <div class="ivu-col ivu-col-span-7">
<!--                <img class="live-cover" :src="article.articleHeadPic==null?-->
<!--'https://myhousekeeping.oss-cn-guangzhou.aliyuncs.com/myhousekeeping/lost.jpg':article.articleHeadPic" style="width:100%;">-->
                <img class="live-cover" v-if="article.articleHeadPic !==null"  :src="article.articleHeadPic" style="width:100%;">
                <div v-if="article.articleHeadPic===null" style="width: 100%;visibility: hidden">&nbsp;</div>
<!--                <img class="live-cover" v-if="article.articleHeadPic!==null" :src="article.articleHeadPic" style="width:100%;">-->
              </div>
