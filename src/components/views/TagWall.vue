  ...
  <div class="tag-wall">
    <panel :title="'标签墙'">
      <div slot="content" class="content">
        <!-- <div  class="live-for" v-for="(item,index) in tagList" :key="item" :name="item">
          <a :href="'/articles/search' + '?keywords=' + item ">
            <iv-icon type="ios-pricetag" :color="index | mapTagColor" /> {{ item }}
          </a>
        </div> -->
        <!--<div id="tagCloud" ></div>-->
        <svg :width='width' :height='height' @mousemove='listener($event)'>
          <a :href="tag.href" target="_blank" v-for='(tag,index) in tagList' :key="tag.href">
